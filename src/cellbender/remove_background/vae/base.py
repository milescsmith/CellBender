...
class FullyConnectedNetwork(torch.nn.Module):
    ...
    def __init__(
        ...
        if use_layer_norm and use_batch_norm:
            msg = "You are trying to use both batch norm and layer norm. That's probably too much norm."
            raise UserWarning(msg)

        # set up layers as a list of Linear modules with appropriate extras
        dim_ins_and_outs = zip([input_dim, *hidden_dims], [*hidden_dims, output_dim], strict=False)
